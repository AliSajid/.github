...
- Collect information about the bug:
  ...
  - Version of Rust, Cargo, Python, or other environment components etc
...
We use the Conventional Commits specification for commit messages. This leads to **more readable messages** that are easy to follow when looking through the **project history**. But also, the commit messages are used to **generate the Project change log**.

## Join The Project Team

We are always open to people joining our team. Please open an issue to alert the team that you are interested in joining. We will then discuss the details in the issue.
